...
const ChallengePoolHandler_CommunityChallengeEventUpdateModule2 = buildModule(
  "ChallengePoolHandler_CommunityChallengeEventUpdateModule2",
  (m) => {
...
export default ChallengePoolHandler_CommunityChallengeEventUpdateModule2;
