...
const ChallengePoolHandlerNoWinnerUpdateModule = buildModule(
  "ChallengePoolHandlerNoWinnerUpdateModule",
  (m) => {
...
export default ChallengePoolHandlerNoWinnerUpdateModule;
