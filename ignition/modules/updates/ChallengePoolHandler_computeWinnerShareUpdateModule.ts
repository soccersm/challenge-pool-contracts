...
const ChallengePoolHandler_computeWinnerShareUpdateModule = buildModule(
  "ChallengePoolHandler_computeWinnerShareUpdateModule",
  (m) => {
...
export default ChallengePoolHandler_computeWinnerShareUpdateModule;
