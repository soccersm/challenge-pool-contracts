...
const ChallengePoolHandler_TournamentChallengeEventUpdateModule = buildModule(
  "ChallengePoolHandler_TournamentChallengeEventUpdateModule",
  (m) => {
...
export default ChallengePoolHandler_TournamentChallengeEventUpdateModule;
